...
<div id="container" style="width: 120px; height: 120px; overflow: auto">
  <my-component intersection-ratio="1" class="exit" intersection-class="enter" style="margin-top:70px;"></my-component>
</div>
<pre>intersectionRatio = <input type="range" min="0" max="1" value="1" step="0.05" oninput="document.querySelector('my-component').intersectionRatio = this.value"</pre>`;